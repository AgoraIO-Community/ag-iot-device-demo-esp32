...
#define BASIC_AUTH "ODYyMGZkNDc5MTQwNDU1Mzg4Zjk5NDIwZmQzMDczNjM6NDkyYzE4ZGNkYjBhNDNjNWJiMTBjYzFjZDIxN2U4MDI="
...
static const char *cert_for_test =
        "eyJzaWduIjoiTS9FMkI3RFBqM09CdDFhZFBDNXhLM1BXa2Uva1llYko1blhDWk01cVNLT3o3MmVuZ05jMUNSSXNRN"
        "HE3Ym53aE55aVFITThFV241d1R2ZUhsNVkrNGpMWVYybGI0QmQ5VDJPYU15UXkxTTQ3V3Z4Vk5CdmxEZEs3OEZBS1U"
        "yaWlFODFQNGV5VkxGL2ZackNxMWRZTytSc3I2N2ZpdEZYdXpGd2pGU1dVR1lPRG1FSjltYllxRk13dXR4VWgzNFZqV"
        "WVBT2dreFdsTndvbXlrMGF6R0ZQWSszVDRBNVdENTNhSytZeE5XUFFRQ1EvaExLNkRqRmZmMDlCbmc4WTlCZi9XSmY"
        "5MjRISzB6dFdWTXZ4bUVrMHBBbmFvQTAwNC8za1gwdkU0SEJ6eDVOZWNpblk2K2YzcFJPUHJWOUpzUmh3MEQxWEtKM"
        "kFoUFR3ZERDeWJRNlpRPT0iLCJjdXN0b20iOiIyMDIyLTAzLTExVDE4OjI1OjQ3KzA4OjAwIiwiY3JlZGVudGlhbCI"
        "6IjRhNWZhMmVlZGRkMmIyYzljN2M0MTk5YWFkNDgyMDViOWIwYzliYjE5ZWFlZmRlYTQ5OTZhYTk5ZjZkZDkyNTIiL"
...
static camera_config_t camera_config = {
  ...
  .frame_size = CONFIG_FRAME_SIZE, //QQVGA-UXGA Do not use sizes above QVGA when not JPEG
...
static int register_new_device(const char *device_id)
{
  ...
  if (rval < 0) {
    ESP_LOGE(TAG, "Failed to register device ID %s, err code %d", account.name, rval);
    return -1;
  }
